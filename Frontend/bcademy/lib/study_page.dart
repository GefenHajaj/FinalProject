...
class _StudyPageState extends State<StudyPage> {
  ...
  void initState() {
    super.initState();
    setState(() {
      smallTopics = Api.getAllSmallTopics(widget.test.pk);
    });
  }
            ...
            return Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text(titles[index], textDirection: TextDirection.rtl, style: TextStyle(fontSize: 24.0),),
                ),
                Padding(
                  padding: const EdgeInsets.only(bottom: 16.0),
                  child: Text(info[index], textDirection: TextDirection.rtl, style: TextStyle(fontSize: 18.0),),
                )
              ],
            );
          },
